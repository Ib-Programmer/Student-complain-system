...
<html lang="en">
    ...
    <body>
      <?php  require 'Authentication.php';
             ...
             $name = $_SESSION["Name"];  
      $sql = "SELECT Id,Name,Regnum,Email,Phonenumber,Password FROM users WHERE  Name =  '$name' ";
      $id = $name =  $regno = $email = $phonenumber = $password =  "";
     ...
     if($result->num_rows > 0){ 
      ...
      if ($_SERVER["REQUEST_METHOD"] == "POST") {
           $id = $regno =  $name = $email = $phonenumber = $password = "";
          function validate_input($data){
            ...
            if(empty($password)){
               $stmt = $connection->prepare("UPDATE  users  SET Name = ?, Regnum = ?,
            Email = ?, Phonenumber = ?  WHERE Id = ? ");
             $stmt->bind_param("sssss",$name,$regno,$email, $phonenumber,$id);
                ...
                Email = ?, Phonenumber = ?, Password = ? WHERE Id = ?");
                 ...
                 $stmt->bind_param("ssssss",$name,$regno,$email, $phonenumber,$hash,$id);
            }
            else{
...
<div class="row">
      ...
      <div class="row ">
        ...
        <div class="row ">
          ...
          <input type="text" name="regno" value= "<?php echo $regno;?>" id="inputname" class="form-control  mb-5" placeholder="name" required autofocus>
          </div>
          <div class="col-md-4 col-lg-4 col-sm-3"></div>
        </div>
      <div class="row ">
